...
export AR6002_REV=7
export AR6002_REV7_VER=${AR6002_REV7_VER:-4}
...
case $OP_FLAVOR in
	...
	export APPS_OUTFILE=${APPS_OUTFILE:-$IMAGEDIR/"ap_sta_mcc_demo.out"}
        ;;
    "ap+sta_scc") 
...
export FLASH_FILE_SUFFIX="_AR400X_REV${AR6002_REV7_VER}${FLASH_FLAVOR}_hostless_${OP_FLAVOR}_${DEMO_BAND}${APPS_OUTFILE_SUFFIX}.bin"
