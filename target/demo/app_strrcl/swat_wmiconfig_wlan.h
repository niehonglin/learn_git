...
void swat_wmiconfig_scan_ctl_set(A_UINT8 device_id, A_UINT32 flag);
void swat_wmiconfig_scan_para_set(A_UINT8 device_id, A_UINT16 max_dwell_time, A_UINT16 pass_dwell_time);
