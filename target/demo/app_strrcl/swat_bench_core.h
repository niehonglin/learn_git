...
{
    A_UINT32 flags;
    A_INT32  socketLocal[CALC_STREAM_NUMBER];
    A_INT32  clientFd[CALC_STREAM_NUMBER];
    A_UINT32 ipAddr[CALC_STREAM_NUMBER];
    A_UINT32 pktSize[CALC_STREAM_NUMBER];
    A_UINT32 numOfPkts[CALC_STREAM_NUMBER];
    A_UINT32 current_packets[CALC_STREAM_NUMBER];
//    A_UINT32 ipAddr[CALC_STREAM_NUMBER];
    A_UINT16 mode[CALC_STREAM_NUMBER];
    A_UINT16 port[CALC_STREAM_NUMBER];
};
