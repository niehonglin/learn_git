...
void 
swat_wmiconfig_scan_para_set(A_UINT8 device_id, A_UINT16 max_dwell_time, A_UINT16 pass_dwell_time)
{
//    qcom_scan_set_para(device_id, max_dwell_time, pass_dwell_time);
}
