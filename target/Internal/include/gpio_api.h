...
/* WARNING: PERIPHERAL IDs CANNOT GO BEYOND 31 */
#define GPIO_PERIPHERAL_ID_NONE             0x0
#define GPIO_PERIPHERAL_ID_UART_0           0x1
#define GPIO_PERIPHERAL_ID_UART_1           0x2
#define GPIO_PERIPHERAL_ID_I2C_MASTER       0x3
#define GPIO_PERIPHERAL_ID_I2S0             0x4
#define GPIO_PERIPHERAL_ID_I2S1             0x5
#define GPIO_PERIPHERAL_ID_SPI_MASTER       0x6
#define GPIO_PERIPHERAL_ID_SPI_SLAVE        0x7
#define GPIO_PERIPHERAL_ID_NOT_BONDED       0x8
...
typedef struct gpio_storerecall_data_s
{
    ...
    A_UINT8                     num_dynamic_configs[GPIO_PIN_COUNT + (GPIO_PIN_COUNT & 3)];
    A_UINT8                     gpioData[1];
