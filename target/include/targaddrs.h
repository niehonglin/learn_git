...
#define AR6006_REV2_HOST_LESS_DATASET_PATCH_ADDRESS     0x467104
#define AR6006_REV1_HOST_LESS_BOARD_DATA_ADDRESS          0x465800
#define AR6006_REV1_HOST_LESS_RAM_RESERVE_SIZE                0x2800
#define HI_REF_CLOCK 40000000
#define HI_OPTION_BAUDRATE 115200
#define HI_UART_NORMAL_TXPIN  11
#define HI_UART_DBG_TXPIN  7
#define HI_PKTLOG_BUF_NUM 0
#define HI_HCI_BRIGE_DISABLE 0
#define HI_MBOX_IO_SIZE 16
#define HI_MBOX_ISR_YIELD_LIMIT 99
#ifdef HAIER_ALLJOYN_EN
    #define ATH_TX_BUF_NUM 3
    #define ATH_RX_BUF_NUM 12
    #define ATH_MGMT_BUF_NUM 6
#else
    #if defined(REV74_TEST_ENV2)&&defined(CONFIG_HOSTLESS)
        #define ATH_TX_BUF_NUM 12
        #define ATH_RX_BUF_NUM 12
        #define ATH_MGMT_BUF_NUM 8
    #else
        #define ATH_TX_BUF_NUM 4
        #define ATH_RX_BUF_NUM 16
        #define ATH_MGMT_BUF_NUM 12
    #endif
#endif
#define HI_BDATA_INITED 1
#define HI_ABI_VER_OVERRIDE 1
#define IOT_HI_OPTION_ARGOS 0x40000000
/***********************/

/*TBD: indeed, all versions of AR6002_REV6, HOST_INTEREST_MAX_SIZE can be 0x200.*/
#if defined(AR6002_REV43) || defined(AR6002_REV61) || defined(AR6002_REV62) || defined(AR6002_REV64)
#define HOST_INTEREST_MAX_SIZE          0x100
#else
#define HOST_INTEREST_MAX_SIZE          0x200
#endif //defined(AR6002_REV43) || defined(AR6002_REV61) || defined(AR6002_REV62) || defined(AR6002_REV64)
...
PREPACK64 struct host_interest_s {
   ...
   /*
    ...
    A_UINT32               hi_option_flag3;                            /* 0x118 */

    /*32 bit bitmap used to enable/disable features*/
    A_UINT32               hi_feature_config;                          /* 0x11c */
...
#define HI_OPTION_EN_HOST_PROXY_FW_DLOAD_MODE   0x02    /* Controls host_proxy boot mode */
#define HI_OPTION_SPI_FLASH_ACCESS_STATUS       0x04    /* indicate flash access status, 0-idle 1-accessing */

/*hi_feature_config flag options*/
#define HI_FEATURE_CONFIG_PRINT_ENABLE          (1 << 0)     /*Control ROM print statements*/
#define HI_FEATURE_CONFIG_MCC_ENABLE            (1 << 1)     /*Control MCC feature enable/disable */

#define DEBUG_PRINT_ENABLED()  \
    (HOST_INTEREST->hi_feature_config & HI_FEATURE_CONFIG_PRINT_ENABLE)

#define TUNABLE_MCC_ENABLED() \
	(HOST_INTEREST->hi_feature_config & HI_FEATURE_CONFIG_MCC_ENABLE)
...
#define AR6002_HOST_INTEREST_ITEM_ADDRESS(item) \
    (UINT_PTR)(&(((struct host_interest_s *)(AR6002_HOST_INTEREST_ADDRESS))->item))

#define AR6003_HOST_INTEREST_ITEM_ADDRESS(item) \
    (UINT_PTR)(&(((struct host_interest_s *)(AR6003_HOST_INTEREST_ADDRESS))->item))

#define AR6004_HOST_INTEREST_ITEM_ADDRESS(item) \
    (UINT_PTR)&((((struct host_interest_s *)(AR6004_HOST_INTEREST_ADDRESS))->item))

#define AR6006_HOST_INTEREST_ITEM_ADDRESS(item) \
    (UINT_PTR)&((((struct host_interest_s *)(AR6006_HOST_INTEREST_ADDRESS))->item))
#else
/*
...
#define AR6006_HOST_INTEREST_ITEM_ADDRESS(item) \
    ((A_UINT32)&((((struct host_interest_s *)(AR6006_HOST_INTEREST_ADDRESS))->item)))
#endif
...
#define TARG_VTOP(TargetType, vaddr) \
        ...
        (((TargetType) == TARGET_TYPE_AR6006) ? AR6006_VTOP(vaddr) : 0))))
...
#define HOST_INTEREST_ITEM_ADDRESS(TargetType, item) \
        ...
        (((TargetType) == TARGET_TYPE_AR6006) ? AR6006_HOST_INTEREST_ITEM_ADDRESS(item) : 0))))
...
#define AR6004_REV1_BOARD_DATA_ADDRESS          0x433800
#define AR6004_REV1_BOARD_DATA_SIZE             6144
#define AR6004_REV1_EXT_BOARD_DATA_SIZE         0
#define AR6004_REV1_RAM_RESERVE_SIZE            19456
#define AR6004_REV1_DATASET_PATCH_ADDRESS       0x4353b0

#ifdef AR6004_FPGA
#define AR6004_REV2_BOARD_DATA_ADDRESS          0x43e400
#else
#define AR6004_REV2_BOARD_DATA_ADDRESS          0x42dc00
#endif
#define AR6004_REV2_BOARD_DATA_SIZE             6144
#define AR6004_REV2_EXT_BOARD_DATA_SIZE         0
#define AR6004_REV2_RAM_RESERVE_SIZE            8704
#define AR6004_REV2_DATASET_PATCH_ADDRESS       0x42efe0
#define AR6004_REV2_UTF_DATASET_PATCH_ADDRESS   0x436fe0

#define AR6004_REV4_BOARD_DATA_ADDRESS          0x435C00
#define AR6004_REV4_BOARD_DATA_SIZE             6144
#define AR6004_REV4_EXT_BOARD_DATA_SIZE         0
#define AR6004_REV4_RAM_RESERVE_SIZE            11264
#define AR6004_REV4_DATASET_PATCH_ADDRESS       0x43665c

#if defined(BUILD_FW_FOR_WIN8)
#define AR6004_REV5_BOARD_DATA_ADDRESS          0x436400
#define AR6004_REV5_BOARD_DATA_SIZE             6144
#define AR6004_REV5_EXT_BOARD_DATA_SIZE         0
#define AR6004_REV5_RAM_RESERVE_SIZE            7168
#define AR6004_REV5_DATASET_PATCH_ADDRESS       0x43785c
#define AR6004_REV5_UTF_DATASET_PATCH_ADDRESS   0x43785c
#elif defined(BUILD_FW_SIZE_64K)
#define AR6004_REV5_BOARD_DATA_ADDRESS          0x436400
#define AR6004_REV5_BOARD_DATA_SIZE             6144
#define AR6004_REV5_EXT_BOARD_DATA_SIZE         0
#define AR6004_REV5_RAM_RESERVE_SIZE            7168
...
#define AR6004_REV5_UTF_DATASET_PATCH_ADDRESS   0x43785c
#else
#define AR6004_REV5_BOARD_DATA_ADDRESS          0x42e400
#define AR6004_REV5_BOARD_DATA_SIZE             6144
#define AR6004_REV5_EXT_BOARD_DATA_SIZE         0
#define AR6004_REV5_RAM_RESERVE_SIZE            7168
#define AR6004_REV5_DATASET_PATCH_ADDRESS       0x42f85c
#define AR6004_REV5_UTF_DATASET_PATCH_ADDRESS   0x43785c
#endif
#define AR6004_REV6_BOARD_DATA_ADDRESS          0x436400
#define AR6004_REV6_BOARD_DATA_SIZE             6144
#define AR6004_REV6_EXT_BOARD_DATA_SIZE         0
#define AR6004_REV6_RAM_RESERVE_SIZE            7168
#define AR6004_REV6_DATASET_PATCH_ADDRESS       0x437db0

#define AR6004_REV8_BOARD_DATA_ADDRESS          0x436400
#define AR6004_REV8_BOARD_DATA_SIZE             6144
#define AR6004_REV8_EXT_BOARD_DATA_SIZE         0
#define AR6004_REV8_RAM_RESERVE_SIZE            7168
#if defined(BUILD_FW_FOR_WIN8)
#define AR6004_REV8_DATASET_PATCH_ADDRESS       0x437d38
#elif defined(BUILD_FW_FOR_CE)
#define AR6004_REV8_DATASET_PATCH_ADDRESS         0x437cec
#else
#define AR6004_REV8_DATASET_PATCH_ADDRESS       0x437800
#endif

#define AR6006_REV1_BOARD_DATA_ADDRESS          0x46B800
#define AR6006_REV1_BOARD_DATA_SIZE             6144
#define AR6006_REV1_EXT_BOARD_DATA_SIZE         0
#define AR6006_REV1_RAM_RESERVE_SIZE            18432
#define AR6006_REV1_DATASET_PATCH_ADDRESS       0x46d864
#define AR6006_REV1_UTF_DATASET_PATCH_ADDRESS   0x475864

#define AR6006_REV2_BOARD_DATA_ADDRESS          0x46B800
#define AR6006_REV2_BOARD_DATA_SIZE             6144
#define AR6006_REV2_EXT_BOARD_DATA_SIZE         0
#define AR6006_REV2_RAM_RESERVE_SIZE            18432
#define AR6006_REV2_DATASET_PATCH_ADDRESS       0x46FEB4
#define AR6006_REV2_UTF_DATASET_PATCH_ADDRESS   0x477EB4

#define AR6006_REV2_TE1_BOARD_DATA_ADDRESS      0x463800
#define AR6006_REV2_TE1_DATASET_PATCH_ADDRESS   0x467EB4

#define AR6006_REV4_BOARD_DATA_ADDRESS          0x46B800
#define AR6006_REV4_BOARD_DATA_SIZE             6144
#define AR6006_REV4_EXT_BOARD_DATA_SIZE         0
#define AR6006_REV4_RAM_RESERVE_SIZE            18432
#define AR6006_REV4_DATASET_PATCH_ADDRESS       0x46FEB4
#define AR6006_REV4_UTF_DATASET_PATCH_ADDRESS   0x477EB4

/* Reserve 4K for OTA test script */
#define AR6004_REV1_RAM_RESERVE_SIZE_FOR_TEST_SCRIPT    4096
#define AR6004_REV1_TEST_SCRIPT_ADDRESS       0x432900
