...
typedef struct  {
    ...
    A_STATUS (*_qcom_get_bssid)(A_UINT8 device_id, A_UINT8 *pbssid);
		A_STATUS (*_qcom_set_appie)(A_UINT8 device_id, A_UINT8 mgmt_type, A_UINT8 *app_ie, A_UINT8 ie_len);
...
#define qcom_set_country_code(device_id,country_code)\
...
#define qcom_allow_aggr_get_tid(device_id, ptx_allow_aggr, prx_allow_aggr)\
    QCOM_WLAN_API_FN(_qcom_allow_aggr_get_tid((device_id),(ptx_allow_aggr),(prx_allow_aggr)))
...
A_STATUS _qcom_set_ht40_flag(QCOM_WLAN_HT40_FLAG flag);
A_STATUS _qcom_set_appie(A_UINT8 device_id, A_UINT8 mgmt_type, A_UINT8 *app_ie, A_UINT8 ie_len);
...
#define qcom_set_keep_alive(device_id, keep_alive_interval)\
        _qcom_set_keep_alive((device_id), (keep_alive_interval)) 
#define qcom_roam_mode_enable(device_id, enable)\
			_qcom_roam_mode_enable((device_id),(enable)) 
#define qcom_roam_para_set(device_id, scan_perid, preason)\
			_qcom_roam_para_set((device_id),(scan_perid),(preason)) 
#define qcom_set_ht40_flag(flag)\
			_qcom_set_ht40_flag((flag)) 
#define qcom_set_appie(device_id, mgmt_type, app_ie, ie_len)\
        _qcom_set_appie((device_id), (mgmt_type), (app_ie), (ie_len))				
#else   /* AR6002_REV74 */
#define qcom_set_bssid(device_id,bssid)\
...
#define qcom_set_appie(device_id, mgmt_type, app_ie, ie_len)\
    QCOM_WLAN_API_FN(_qcom_set_appie((device_id), (mgmt_type), (app_ie), (ie_len)))	
#endif /* AR6002_REV74 */
#endif
