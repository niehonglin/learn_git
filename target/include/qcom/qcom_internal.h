...
/******************************** COM ********************************/
 typedef void (*WMI_CONNECT_EVENT_CB)(A_UINT8 device_id, int value);
...
typedef enum {
    ...
    WMI_PARAM_GET_REPLY_EVENTID,           /*0x90eF*/ 
...
enum SOCKET_CMDS
{
    ...
    SOCK_DHCPS_SUCCESS_CALLBACK,    /*66*/ /*DHCP Server Success Callback*/
    SOCK_DHCPC_SUCCESS_CALLBACK,    /*67*/ /*DHCP Client Success Callback*/
...
extern void _qcom_sta_reconnect(A_UINT8 device_id, A_UINT8 * bssid, A_UINT16 channel);
//ap
...
//dhcp
extern int  _qcom_dhcp_clean_from_mac(void *hwaddr, A_UINT8 len);

//common
extern void _qcom_mac_read(A_UINT8 device_id, A_UINT8 * mac);
extern void _qcom_reg_write(A_UINT32 address, A_UINT32 value);
extern void _qcom_reg_read(A_UINT32 address, A_UINT32 * pvalue);
extern void _qcom_wlan_wakemgr_power_down(unsigned int wm_time_cn);
extern void _qcom_dev_connected(A_UINT8 device_id, A_UINT8 * state);
extern void _qcom_switch_mode(A_UINT8 device_id, A_UINT8 newOpMode, A_UINT8 newSubOpMode);
extern void _qcom_get_brssi_avg(A_UINT8 device_id, A_UINT8 * rssi);
extern void _noise_floor_print(void);
