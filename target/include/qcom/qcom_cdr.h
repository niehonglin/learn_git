...
//#endif
    ...
    A_STATUS (*_qcom_set_ipv6_status)(void *cmd);
...
#define QCOM_CDR_API_FN(fn) qcom_cdr_api_indirect_table.fn
   ...
   A_STATUS _qcom_ota_read_ota_area_cmd(void *cmd);
    ...
    A_STATUS _qcom_ota_partition_verify_checksum_cmd(void *cmd);
    A_STATUS _qcom_ota_partition_write_data_cmd(A_UINT32 offset, A_UINT8 *buf,A_UINT32 size);
    A_STATUS _qcom_set_ipv6_status_cmd(void *cmd);
		A_STATUS _qcom_set_appie_cmd(A_UINT8 device_id, A_UINT8 mgmt_type, A_UINT8 *app_ie, A_UINT8 ie_len); 
...
#define qcom_http_server_enable(_en) \
	QCOM_CDR_API_FN(_qcom_http_server_enable((_en)))
...
#define qcom_http_client_cmd(_cmd, _url, _data) \
	QCOM_CDR_API_FN(_qcom_http_client_cmd((_cmd), (_url), (_data)))
...
#define qcom_set_ipv6_status_cmd(cmd)\
      _qcom_set_ipv6_status_cmd((cmd))

#define qcom_set_appie_cmd(device_id, mgmt_type, app_ie, ie_len)\
        _qcom_set_appie_cmd((device_id), (mgmt_type), (app_ie), (ie_len)) 
...
#define qcom_tcp_conn_timeout_cmd(cmd)\
          QCOM_CDR_API_FN(qcom_tcp_conn_timeout_cmd((cmd)))

#define qcom_param_set_cmd(dev_id,which_param,data,data_length)\
          QCOM_CDR_API_FN(_qcom_param_set_cmd((dev_id),(which_param),(data),(data_length)))
          
#define  qcom_perform_ba(device_id,tid)\
          QCOM_CDR_API_FN(_qcom_perform_ba((device_id),(tid)))
...
#define qcom_set_ipv6_status_cmd(cmd)\
        QCOM_CDR_API_FN(_qcom_set_ipv6_status_cmd((cmd)))

#define qcom_set_appie_cmd(device_id, mgmt_type, app_ie, ie_len)\
        QCOM_CDR_API_FN(_qcom_set_appie_cmd((device_id), (mgmt_type), (app_ie), (ie_len))) 
#endif
