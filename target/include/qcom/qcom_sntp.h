...
void (*_qcom_sntp_get_status)(A_UINT8 device_id, A_BOOL* status);
...
void _qcom_sntp_get_status(A_UINT8 device_id, A_BOOL* status);
#define qcom_sntp_get_status(device_id, status) \
   _qcom_sntp_get_status((device_id),(status))
...
#define qcom_sntp_get_status(device_id, status)  \
   QCOM_SNTP_API_FN(_qcom_sntp_get_status((device_id), (status)))
