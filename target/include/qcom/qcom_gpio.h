...
#define QCOM_PERIPHERAL_ID_I2C              GPIO_PERIPHERAL_ID_I2C_MASTER
#define QCOM_PERIPHERAL_ID_I2S0             GPIO_PERIPHERAL_ID_I2S0
#define QCOM_PERIPHERAL_ID_I2S1             GPIO_PERIPHERAL_ID_I2S1
...
#define QCOM_PERIPHERAL_ID_PWM_HW           GPIO_PERIPHERAL_ID_PWM_HW
#define QCOM_PERIPHERAL_ID_PWM_SW           GPIO_PERIPHERAL_ID_PWM_SW
...
#ifndef AR6002_REV74
#if 0
    A_STATUS (*_qcom_gpio_apply_configuration)(gpio_peripheral_pin_info_t *pin_map, A_UINT32 id, A_BOOL low_power_mode);
    void (*_qcom_gpio_get_active_peripherals)(gpio_peripheral_pin_info_t pin_map, A_UINT32 *pPeripheral_map);
#endif
    A_STATUS (*_qcom_gpio_apply_peripheral_configuration)(A_UINT32 peripheral_id, A_BOOL low_power_mode);
    A_STATUS (*_qcom_gpio_add_alternate_configurations)(A_UINT32 pin_num, A_UINT32 num_configs,
                                    qcom_pin_peripheral_config_t    *pPinConfigs);
...
#if 0
#define qcom_gpio_apply_configuration(pin_map, low_pwr_mode) \
    QCOM_GPIO_API_FN(_qcom_gpio_apply_configuration((pin_map), (low_pwr_mode)))

#define qcom_gpio_get_active_peripherals(pin_map, pPeripheralMap) \
    QCOM_GPIO_API_FN(_qcom_gpio_get_active_peripherals((pin_map), (pPeripheralMap)))
#endif
...
#define qcom_gpio_peripheral_failure_check(peripheral_id, pPeripheralMap) \
    QCOM_GPIO_API_FN(_qcom_gpio_peripheral_pin_conflict_check((peripheral_id), (pPeripheralMap)))
#else   /* AR6002_REV74 */
#if 0
void _qcom_gpio_apply_configuration(gpio_peripheral_pin_info_t *pin_map, A_UINT32 id, A_BOOL low_power_mode);
void _qcom_gpio_get_active_peripherals(gpio_peripheral_pin_info_t pin_map, A_UINT32 *pPeripheral_map);
#endif
...
#if 0
#define qcom_gpio_apply_configuration(pin_map, id, low_pwr_mode) \
            (_qcom_gpio_apply_configuration((pin_map), id, (low_pwr_mode)))

#define qcom_gpio_get_active_peripherals(pin_map, pPeripheralMap) \
            (_qcom_gpio_get_active_peripherals((pin_map), (pPeripheralMap)))
#endif

#define qcom_gpio_apply_peripheral_configuration(peripheral_id, low_pwr_mode) \
            (_qcom_gpio_apply_peripheral_configuration((peripheral_id), (low_pwr_mode)))

#define qcom_gpio_add_alternate_configurations(pin_num, num_configs, pPinConfigs) \
            (_qcom_gpio_add_alternate_configurations((pin_num), (num_configs), (pPinConfigs)))

#define qcom_gpio_get_interrupt_pin_num(interrupt_num, pPinNum) \
            (_qcom_gpio_get_interrupt_pin_num((interrupt_num), (pPinNum)))

#define qcom_gpio_peripheral_pin_conflict_check(peripheral_id, pPeripheralMap) \
            (_qcom_gpio_peripheral_pin_conflict_check((peripheral_id), (pPeripheralMap)))
