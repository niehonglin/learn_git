...
typedef struct
{
	...
	A_STATUS
	(* _CDR_wmi_http_server)(WMI_STRUCT_CDR * wmip, A_INT32 enable);
	A_STATUS
	...
	A_STATUS
	(* _CDR_wmi_http_client_cmd)(WMI_STRUCT_CDR * wmip,A_UINT32 cmd, A_UINT8 *url, A_UINT8 *data);
	A_STATUS
...
//#endif
    ...
    A_STATUS (*_CDR_wmi_set_ipv6_status_cmd)(WMI_STRUCT_CDR * wmip,void *cmd);
		A_STATUS (*_CDR_wmi_set_appie_cmd)(WMI_STRUCT_CDR * wmip, A_UINT8 mgmt_type, A_UINT8 *app_ie, A_UINT8 ie_len);
...
#define CDR_wmi_http_server(_wmip, _en) \
	WMI_CDR_API_FN(_CDR_wmi_http_server((_wmip), (_en)))
...
#define CDR_wmi_http_client_cmd(_wmip, _cmd, _url, _data) \
	WMI_CDR_API_FN(_CDR_wmi_http_client_cmd((_wmip), (_cmd), (_url), (_data)))
...
#define CDR_wmi_set_ipv6_status_cmd(wmip,cmd)\
         _CDR_wmi_set_ipv6_status_cmd((wmip),(cmd))
         
#define CDR_wmi_set_appie_cmd(wmip, mgmt_type, app_ie, ie_len) \
        _CDR_wmi_set_appie_cmd((wmip), (mgmt_type), (app_ie), (ie_len)) 

extern A_STATUS _CDR_wmi_wps_config_state_set_cmd(WMI_STRUCT_CDR *wmip, WMI_WPS_CONFIG_SET_CMD *wpsConfigStateSet);
#define  CDR_wmi_wps_config_state_set_cmd(wmip, cmd)\
         _CDR_wmi_wps_config_state_set_cmd((wmip), (cmd))
...
#define  CDR_wmi_ota_parse_image_hdr_cmd(wmip,cmd) \
    WMI_CDR_API_FN(_CDR_wmi_ota_image_hdr_cmd((wmip),(cmd)))
...
#define  CDR_wmi_tcp_conn_timeout_cmd(wmip,cmd) \
    WMI_CDR_API_FN(_CDR_wmi_tcp_conn_timeout_cmd((wmip), (cmd)))
...
#define  CDR_wmi_perform_ba_cmd(wmip,tid) \
            WMI_CDR_API_FN(_CDR_wmi_perform_ba_cmd((wmip), (tid)))

#define CDR_wmi_set_ipv6_status_cmd(wmip,cmd)\
        WMI_CDR_API_FN(_CDR_wmi_set_ipv6_status_cmd((wmip),(cmd)))    

#define CDR_wmi_set_appie_cmd(wmip, mgmt_type, app_ie, ie_len) \
    WMI_CDR_API_FN(_CDR_wmi_set_appie_cmd((wmip), (mgmt_type), (app_ie), (ie_len)))        
