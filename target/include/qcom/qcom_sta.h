...
A_STATUS (*_qcom_sta_connect_with_bssid)(A_UINT8 device_id, A_CHAR ssid[], A_UINT8 *pbssid);
...
#define qcom_sta_connect_with_bssid(id, ssid,bssid) \
		_qcom_sta_connect_with_bssid((id), (ssid), (bssid))
