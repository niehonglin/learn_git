...
typedef struct  {
	A_INT32 (*_qcom_i2c_init)(I2C_FREQ freq);
...
#if  (CONFIG_GPIO == 1)
A_INT32 patch_qcom_i2c_init(I2C_FREQ freq);
A_INT32 patch_qcom_i2c_fini(VOID);
#endif

#ifdef AR6002_REV74
#define qcom_i2c_init(freq)       patch_qcom_i2c_init((freq))
#define qcom_i2c_fini()               patch_qcom_i2c_fini()
#else
#define qcom_i2c_init(_freq) \
    QCOM_I2C_API_FN(_qcom_i2c_init((_freq)))
#define qcom_i2c_fini() \
   QCOM_I2C_API_FN(_qcom_i2c_fini())
#endif /* AR6002_REV74 */
