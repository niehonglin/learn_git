...
struct dbMasterTable_t g_dbTableGen[MAX_DB_TABLE_TAGS] =
		{
			{0, 0, KEY_BASED_TABLE_SEARCH, "RE",
					sizeof(regDomainPairs), (char *)regDomainPairs},
			{0, 0, KEY_BASED_TABLE_SEARCH, "RE",
					sizeof(allCountries), (char *)allCountries},
			{0, 0, INDEX_BASED_TABLE_ACCESS, "RE",
					sizeof(regDmn5GhzFreq), (char *)regDmn5GhzFreq},
			{0, 0, INDEX_BASED_TABLE_ACCESS, "RE",
					sizeof(regDmn2Ghz_BG_Freq), (char *)regDmn2Ghz_BG_Freq},
			{0, 0, KEY_BASED_TABLE_SEARCH, "RE",
					sizeof(regDomains), (char *)regDomains}
		};
